...
$q = "SELECT * FROM persons WHERE nscho_country = 'USA'";
...
$get_total_rows = 0;
$results = $mysqli->query("SELECT * FROM persons WHERE nscho_country = 'USA'");
if($results){
...
<title>List of Scholarship in USA</title>
...
$(document).ready(function() {
	...
	$('#results').load("usa_fetch_pages.php", {'page':track_click}, function() {track_click++;}); //initial data to load
	...
	$(".load_more").click(function (e) { //user clicks on button
		...
		if(track_click <= total_pages) //make sure user clicks are still less than total pages
		{
			...
			$.post('usa_fetch_pages.php',{'page': track_click}, function(data) {
