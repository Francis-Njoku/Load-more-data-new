...
include("scholarship_crul.php");

// Decode Json
//$curl = file_get_contents('https://homeworks.ng/api/authenticate');
...
if ($data['status'][0] == 'success') {
    ...
    if (isset($_GET['cid']) &&
        is_numeric($_GET['cid'])
    ) { // Make sure there's a scholarship ID!
...
//echo '<div align="center">This page has been accessed in error!</div>';
   ...
   header('Location: https://www.homeworks.ng/login');
}
 // Complete the page:
