...
$q = "SELECT * FROM persons WHERE nscho_country = 'Nigeria'";
...
<div class='section section-breadcrumbs' style='margin-top: 100px; background-color:#2e3456;'>
			<div class='container'>
				<div class='row'>
					<div class='col-md-12'>
						<h1 class='scholar'>List of Scholarships in Nigeria</h1>
					</div>
				</div>
			</div>
		</div>
...
$get_total_rows = 0;
$results = $mysqli->query("SELECT * FROM persons WHERE nscho_country = 'Nigeria'");
if($results){
...
<title>List of Scholarship in Nigeria</title>
...
$(document).ready(function() {
	...
	$('#results').load("nigeria_fetch_pages.php", {'page':track_click}, function() {track_click++;}); //initial data to load
	...
	$(".load_more").click(function (e) { //user clicks on button
		...
		if(track_click <= total_pages) //make sure user clicks are still less than total pages
		{
			...
			$.post('nigeria_fetch_pages.php',{'page': track_click}, function(data) {
