...
$results = $mysqli->prepare("SELECT nscho_id, nscho_name, nscho_deadline, nscho_country, nscho_currency, nscho_amount, nscho_essay, nscho_elig FROM persons WHERE nscho_country = 'Australia' ORDER BY nscho_name  DESC LIMIT $position, $item_per_page");
