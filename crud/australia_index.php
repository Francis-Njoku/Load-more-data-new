...
$q = "SELECT * FROM persons WHERE nscho_country = 'Australia'";
...
$get_total_rows = 0;
$results = $mysqli->query("SELECT * FROM persons WHERE nscho_country = 'Australia'");
if($results){
...
$(document).ready(function() {
	...
	$('#results').load("australia_fetch_pages.php", {'page':track_click}, function() {track_click++;}); //initial data to load
	...
	$(".load_more").click(function (e) { //user clicks on button
		...
		if(track_click <= total_pages) //make sure user clicks are still less than total pages
		{
			...
			$.post('australia_fetch_pages.php',{'page': track_click}, function(data) {
...
$data['total_referred_in'] = $this->Referrals_form_model->total_referred_in(); //get referral data
$this->load->view("referrals_form_view", $data);
}